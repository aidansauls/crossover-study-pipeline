...
local({
  ...
  .REG <- list(
    ...
    "09_period_condition_cell_means"      = list(desc = "Cell means by period and sequence",                              scoring = "Full",            role = "Descriptive",   note = ""),
    ...
    # Comparison outputs
    "variant_comparison_restricted_results" = list(desc = "Cross-run restricted-score summary (all compared variants)",  scoring = "Restricted",      role = "Cross-run",     note = "Cross-run comparison table")
  )
